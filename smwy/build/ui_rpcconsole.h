...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "AXFunds - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "AXFunds Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the AXFunds debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the AXFunds-Qt help message to get a list with possible AXFunds command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
