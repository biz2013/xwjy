...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About AXFunds", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>AXFunds</b> version", Q_NULLPTR));
...
"Copyright \302\251 2014 The AXFunds developers", Q_NULLPTR));
