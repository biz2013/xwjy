...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 AXF"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 AXF"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 AXF"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 AXF"));
        ...
        labelBalance->setText(QStringLiteral("123.456 AXF"));
